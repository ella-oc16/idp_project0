...
void loop() {
    ...
    bottom_sensor_state = digitalRead(bottom_sensor_pin)
    ...
    if(right_sensor_state = 0 && left_sensor_state = 0 && top_sensor_state = 1 && bottom_sensor_state = 1) {
    ...
    if(right_sensor_state = 1 && left_sensor_state = 0 && top_sensor_state = 1 && bottom_sensor_state = 1) {
    ...
    if(right_sensor_state = 0 && left_sensor_state = 1 && top_sensor_state = 1 && bottom_sensor_state = 1) {
    ...
    if(right_sensor_state = 1 && left_sensor_state = 1 && top_sensor_state = 0 && bottom_sensor_state = 1)
